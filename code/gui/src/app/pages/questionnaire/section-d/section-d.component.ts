...
export class SectionDComponent implements OnInit {
  ...
  ngOnInit() {
   ...
   buildForm() {
     this.form = new FormGroup({
       ...
       numberOfMPM: new FormControl(this.d.numberOfMPM),
       dateOfDiagnosis: new FormControl(this.d.dateOfDiagnosis),
       primaryTumorKnown: new FormControl(this.d.primaryTumorKnown),
       ...
       solarElastosis: new FormControl(this.d.otherMainHistopatologicFeatures.solarElastosis, [Validators.required]),
       lateralMarginStatus: new FormControl(this.d.otherMainHistopatologicFeatures.lateralMarginStatus),
       deepMarginStatus: new FormControl(this.d.otherMainHistopatologicFeatures.deepMarginStatus, [Validators.required]),
       ...
       sourceOfData: new FormControl(this.d.mutationalData.sourceOfData, [Validators.required]),
  ...
  save() {
    ...
    console.log(this.d);
    this.questionnaireService.insertSection(this.authenticationService.currentUserValue.username, 'd', this.d).subscribe( (res) => {
      console.log(res);
    });
  }
}
